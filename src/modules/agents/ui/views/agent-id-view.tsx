...
// (keeping your extra imports is optional; they aren't needed)
...
export const AgentIdView = ({ agentId }: Props) => {
  // ✅ suspense hook returns an object
  ...
  const removeAgent = trpc.agents.remove.useMutation({
    onSuccess: async () => {
      // invalidate agents caches; then navigate
      await utils.agents.getMany.invalidate();
      await utils.agents.getOne.invalidate({ id: agentId });
      router.push("/agents");
    },
  });
  ...
  return (
    <>
      ...
      <UpdateAgentDialog
        ...
        onOpenChangeAction={setUpdateAgentDialogOpen}
        initialValues={data}
      />
